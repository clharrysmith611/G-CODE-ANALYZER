...
1. Download the latest release (ZIP) from the (https://github.com/clharrysmith611/G-CODE-ANALYZER) page
2. Extract the archive to your desired location
3. Ensure [.NET 9.0 Runtime](https://dotnet.microsoft.com/download/dotnet/9.0) is installed
4. Run `GcodeAnalyzer.exe`, or 'setup.exe' to install, or open with Visual Studio 2026 for development.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/clharrysmith611/G-CODE-ANALYZER.git
   ```
2. Open `GcodeAnalyzer.sln` in Visual Studio 2026 or later
...
- Open an [Issue](https://github.com/clharrysmith611/G-CODE-ANALYZER/issues)
