...
1. Download the latest release (ZIP) from the (https://github.com/clharrysmith611/GcodeAnalyzer) page
...
1. Clone the repository:
   ```bash
   git clone https://github.com/clharrysmith611/GcodeAnalyzer.git
   ```
...
- Open an [Issue](https://github.com/clharrysmith611/GcodeAnalyzer/issues)
