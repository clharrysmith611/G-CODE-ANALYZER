...
#### Selection Menu
Work with the simulator to select specific code sections:
- **Select All** (`Ctrl+A`): Select all text
- **Select None**: Deselect current selection
- **Invert Selection**: Toggle selected/unselected regions
- **Select From Simulator Position to Start/End**: Range selection based on simulation
- **Set Selection Start/End at Simulator Position**: Two-step precise selection
